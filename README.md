...
| ONNX Runtime benchmark | `benchmark_onnx.py`, `benchmark_results_video2.md`, `benchmark_results_final.md` |
| Training summary | [Colab Notebook](https://colab.research.google.com/drive/13Qmzcx_gg2xaNRGn4CuliEdFfybyHTe_?usp=sharing) |
| Input videos (assets) | [Google Drive — Assets](https://drive.google.com/drive/folders/1ry2DJdjhWIAPtlXrgKmAoQzuTxlwRW-N?usp=drive_link) |
| Sample output (annotated video + alerts) | [Google Drive — Outputs](https://drive.google.com/drive/folders/1yYCo6f_KDQFUPv0lm0MzL9iLfs4rQ_os?usp=drive_link) |
...
> **Note:** Video assets and output files exceed GitHub's file size limit and are hosted on Google Drive.

- **Input videos (assets):** [Google Drive — Assets](https://drive.google.com/drive/folders/1ry2DJdjhWIAPtlXrgKmAoQzuTxlwRW-N?usp=drive_link)
- **Output videos + alerts:** [Google Drive — Outputs](https://drive.google.com/drive/folders/1yYCo6f_KDQFUPv0lm0MzL9iLfs4rQ_os?usp=drive_link)

Outputs include:
- `final/annotated.avi` — final.mp4 with detections, zone overlays, counts, and flow.
- `video2/annotated.avi` — video2.mp4 with detections, zone overlays, counts, and flow.
